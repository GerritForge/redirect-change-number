  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    try {
      ...
      boolean areForwardedHeadersInRequest =
          forwardedHost != null && forwardedPort != null && forwardedProto != null;
      ...
      if (!areForwardedHeadersInRequest && maybeChangeNumber.get().isPresent()) {
        LOGGER.warn(
            "Forwarded headers in request: {} are: Host: {}. Port: {}. Proto: {}",
