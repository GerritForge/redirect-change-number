...
public class RedirectChangeNumberFilter extends AllRequestFilter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    try {
      ...
      boolean areXForwardedHeadersInRequest =
          areXForwardedHeadersInRequest(maybeXFHostHeader, maybeXFPortHeader, maybeXFHostHeader);
      if (areXForwardedHeadersInRequest
  ...
  private boolean areXForwardedHeadersInRequest(
      Optional<String> maybeXFHostHeader,
      Optional<Integer> maybeXFPortHeader,
      Optional<String> maybeXFProtoHeader) {
